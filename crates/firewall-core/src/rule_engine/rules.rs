...
pub static RULE_TABLE: &[Rule] = &[
    ...
    Rule {
        ...
        evaluate: |input| {
            ...
            let has_verb = contains_any_ci(
                &lower,
                &["ecris", "cree", "genere", "implemente", "programme"],
            );
            let has_noun = contains_any_ci(
                &lower,
                &[
    ...
    Rule {
        ...
        evaluate: |input| {
            ...
            let has_verb = contains_any_ci(
                &lower,
                &["escribe", "crea", "genera", "implementa", "programa"],
            );
            let has_noun = contains_any_ci(
                &lower,
                &[
    ...
    Rule {
        ...
        evaluate: |input| {
            let lower = input.to_lowercase();
            let is_greeting = contains_any_ci(
                &lower,
                &[
                    "guten tag",
                    "guten morgen",
    ...
    Rule {
        ...
        evaluate: |input| {
            ...
            let is_greeting = starts_with_any_ci(
                stripped,
                &[
                    "buenos dias",
                    "buenas tardes",
    ...
    Rule {
        ...
        evaluate: |input| {
            ...
            let is_ack = contains_any_ci(
                &lower,
                &["d'accord", "entendu", "compris", "bien sur", "parfait"],
            );
            if is_ack && word_count(input) <= 5 {
                RuleOutcome::Pass(MatchedIntent::ConversationalAcknowledgement)
            } else {
    ...
    Rule {
        ...
        evaluate: |input| {
            ...
            let is_ack = contains_any_ci(
                &lower,
                &["entendido", "por supuesto", "de acuerdo", "claro que si"],
            );
            if is_ack && word_count(input) <= 5 {
                RuleOutcome::Pass(MatchedIntent::ConversationalAcknowledgement)
            } else {
